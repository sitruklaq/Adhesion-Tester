...
%This test moves the force gauge 107µm towards the substrate at 5µm/s but stops if the target preload is hit. Once hit, it will dwell for a few seconds then start pulling the force gauge back at 5µm/s until the load is stable around 0
